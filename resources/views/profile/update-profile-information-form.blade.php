<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="grid grid-cols-2 col-span-6 sm:col-span-4">
            <div>
                <x-jet-label for="owner" value="{{ __('صاحب موقع') }}" />
                <input type="radio" name="role" id="owner" value="1" wire:model.defer="state.role_id" />
            </div>

            <div>
                <x-jet-label for="owner" value="{{ __('مستخدم عادي') }}" />
                <input type="radio" name="role" id="owner" value="2" wire:model.defer="state.role_id" />
            </div>
        </div>
